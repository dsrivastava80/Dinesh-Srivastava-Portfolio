  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        ...
        {
          user_name: form.name,
          my_name: "Dinesh Srivastava",
          user_email: form.email,
          my_email: "dsrivastava.email@gmail.com",
      ...
      <div className="w-full min-h-screen">
        ...
        <div className="xl:mt-12 flex xl:flex-row flex-col-reverse gap-6 lg:gap-10 overflow-hidden text-white px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="mt-4 flex flex-col gap-2 text-slate-300 font-medium tracking-wide">
              <p className="flex items-center gap-2"><span className="text-cyan-500">📍</span> Bengaluru, India</p>
              <p className="flex items-center gap-2"><span className="text-cyan-500">✉️</span> dsrivastava.email@gmail.com</p>
              <p className="flex items-center gap-2"><span className="text-cyan-500">📞</span> +91-7838369601</p>
              <p className="flex items-center gap-2"><span className="text-cyan-500">🔗</span> <a href="https://linkedin.com/in/" target="_blank" rel="noopener noreferrer" className="text-cyan-400 hover:text-cyan-300 transition-colors">LinkedIn Profile</a></p>
            </div>
            ...
            >
              ...
              <button
                ...
                type="submit"
                style={magneticStyle}
                className="bg-cyan-600 py-3 px-6 sm:px-8 rounded-md outline-none w-fit text-white font-semibold shadow-lg shadow-cyan-500/20 text-sm sm:text-base hover:bg-cyan-700 transition"
              >
