    ...
    <>
      <div>
        <motion.div variants={textVariant()}>
          <p className={`${styles.sectionSubText} `}>Business Value</p>
          <h2 className={`${styles.sectionHeadText}`}>Strategic Initiatives.</h2>
        </motion.div>
...
export default SectionWrapper(Works, "strategic-initiatives");
