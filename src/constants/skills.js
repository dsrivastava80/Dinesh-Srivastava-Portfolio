...
export const SKILLS = {
  js: {
    ...
    shortDescription:
      "Enterprise agile frameworks, SAFe, and continuous delivery models for infrastructure.",
    color: "#f0db4f",
  ...
  ts: {
    ...
    shortDescription:
      "Continuous Integration and Continuous Deployment pipelines for infrastructure modernization.",
    color: "#007acc",
  ...
  html: {
    ...
    shortDescription:
      "Expertise in routing, switching, datacenter fabrics, and enterprise network design.",
    color: "#e34c26",
  ...
  css: {
    ...
    label: "AVAYA",
    shortDescription:
      "Enterprise voice architecture, unified communications, and contact center solutions.",
    color: "#563d7c",
  ...
  react: {
    ...
    shortDescription:
      "Certified execution of large-scale, multi-million dollar infrastructure transformation programs.",
    color: "#61dafb",
  ...
  vue: {
    ...
    label: "Prince2",
    shortDescription:
      "Process-based methodology for effective, heavily-governed enterprise project management.",
    color: "#41b883",
  ...
  nextjs: {
    ...
    label: "IT Leadership",
    shortDescription:
      "Leading cross-functional global teams, managing continuous service delivery, and strategic GCC operational scale.",
    color: "#fff",
